  ...
  projects: [
    {
      ...
      status: "live",
      date: "March 2025",
      oneLiner: "Copy. Paste. Get hired - a fast tool for generating and refining cover letters.",
    ...
    },
    {
      ...
      status: "prototype",
      date: "2022",
      oneLiner: "First place Chainlink Hackathon winner focused on verifiable Merkle tree computation.",
      ...
      details:
        "VMTree explores affordable on-chain privacy using verifiable Merkle tree updates backed by cryptographic proofs and Chainlink infrastructure. The project won first place in the Chainlink Spring Hackathon.",
    ...
    },
    {
      ...
      status: "concept",
      date: "May 2025",
      oneLiner: "Avalanche Summit Hackathon honorable mention winner.",
    ...
    },
    {
      ...
      status: "prototype",
      date: "June 2025",
      oneLiner: "Trust-minimized electricity meter protocol for transparent energy reporting.",
    ...
    },
    {
      ...
      status: "prototype",
      date: "April 2026",
      oneLiner: "A prototype marketplace concept for smoother project handover and execution flows.",
      ...
      details:
        "HandOff is built around reducing coordination friction when projects move from planning to execution. The product direction emphasizes clarity, trust, and clean transfer of context between stakeholders.",
    ...
    },
    {
      ...
      status: "live",
      date: "2024-Current",
      oneLiner: "All-in-one personal finance dashboard for budgeting, cashflow, and portfolio tracking.",
    ...
    },
    {
      ...
      status: "live",
      date: "2022-2024",
      oneLiner: "Course designer and contributor for the BESIDE Erasmus+ blockchain-in-digital-finance project.",
      ...
      details:
        "BESIDE (Blockchain usE caSes In Digital financE, Erasmus+ 2022-1-DE02-KA220-VET-000089587) focused on practical blockchain education in digital finance. Work included course design and project contribution across the program.",
      pitchDeckUrl: ""
    },
    {
      slug: "ethergy",
      ...
      status: "concept",
      date: "2021-2022",
      oneLiner: "Early concept project exploring blockchain and energy-system intersections.",
      ...
      socials: [],
      details:
        "Ethergy is a concept-stage project from 2021-2022 investigating how web3 primitives can support transparent, user-centered energy applications.",
      pitchDeckUrl:
    ...
    },
    {
      ...
      status: "concept",
      date: "2022-2023",
      oneLiner: "Concept project exploring regenerative finance narratives and coordination.",
      ...
      details:
        "Liquid Rainforests is a concept focused on climate-aligned digital finance storytelling and ecosystem-building.",
